                        ...
                        <div class="box-body !p-[3rem]">
                            ...
                            <div class="grid grid-cols-12 gap-y-4">
                                <div class="xl:col-span-12 col-span-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg w-full !rounded-md" id="email" name="email" placeholder="user name">
                                ...
                                <div class="xl:col-span-12 col-span-12 grid mt-2">
                                    <x-primary-button class="ti-btn ti-btn-primary !bg-primary !text-white !font-medium">
                                        {{ __('Log in') }}
                                    </x-primary-button>
                                </div>
                            </div>
