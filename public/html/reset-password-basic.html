                    ...
                    <div class="box-body !p-[3rem]">
                        ...
                        <div class="grid grid-cols-12 gap-y-4">
                            ...
                            <div class="xl:col-span-12 col-span-12 grid mt-2">
                                <a href="sign-in-basic.html" class="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Create</a>
                            </div>
                        </div>
                        <div class="text-center">
                            <p class="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Already have an account? <a href="sign-in-basic.html" class="text-primary">Sign In</a></p>
                        </div>
